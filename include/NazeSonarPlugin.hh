...
#ifndef _GAZEBO_NAZE_SONAR_PLUGIN_HH_
#define _GAZEBO_NAZE_SONAR_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE NazeSonarPlugin : public SensorPlugin
  {
    /// \brief Constructor
    public: NazeSonarPlugin();

    /// \brief Destructor
    public: virtual ~NazeSonarPlugin();
    ...
    private: std::unique_ptr<NazeSonarPluginPrivate> dataPtr;
  };
}
#endif
